...
public class Notes {
    public static void main(String[] args) {
        ...
        // can declare primitive types like this too, it has some extra methods on them
        // see wrapper class below
        Integer a1 = 4;
        int a2 = a1.compareTo(3);
        ...
        // System.exit(0); // used to end Java program immediately
        ...
        System.out.println("\nArray: reference type -");
        // syntax when user will enter array elements
        ...
        // syntax when array elements already known
        int[] numbers2 = { 3, 2, 1 };
        ...
        // Irregular arrays or jagged arrays is a group of arrays where each array can
        // be of different sizes. We can create a 2D array with variable number of
        // columns in each row.

        // eg. Print pattern using jagged arrays
        // 1
        // 2 3
        // 4 5 6
        ...
        // int z2 = x2 + 2; // error, 'x2' is double so result will be double
        int z2 = (int) x2 + 2; // explicit casting to int
        ...
        System.out.println("\nFor loop -");
        for (int i = 0; i < 5; i++) {
            System.out.println("For loop line " + (i + 1));
        }

        // while loop - useful when we don't know the number of times loop should be
        // executed, unlike for loop where we know the number, hence we use counter
        System.out.println("\nWhile loop -");
        String input = "Quit";
